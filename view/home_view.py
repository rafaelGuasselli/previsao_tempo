...
class HomeView(Tk.Tk):
	...
	def __addHeader(self):
		...
		self.startDateLabel = Tk.Label(self.header, text="Data inicial: ", font=("Arial", 14, "bold"), justify="left")
		self.startDateInput = Tk.Entry(self.header, name="startDate")

		self.endDateLabel = Tk.Label(self.header, text="Data final: ", font=("Arial", 14, "bold"), justify="left")
		self.endDateInput = Tk.Entry(self.header, name="endDate")
		
		self.cityLabel = Tk.Label(self.header, text="Cidade: ", font=("Arial", 14, "bold"), justify="left")
		...
		self.startDateLabel.grid(row=0, column=0, padx=10, pady=10, sticky="W")
		self.startDateInput.grid(row=0, column=1, padx=10, pady=10, sticky="W")	

		self.endDateLabel.grid(row=0, column=2, padx=10, pady=10, sticky="W")
		self.endDateInput.grid(row=0, column=3, padx=10, pady=10, sticky="W")

		self.cityLabel.grid(row=0, column=4, padx=10, pady=10, sticky="W")
