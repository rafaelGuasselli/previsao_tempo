...
class ScrollableContainer(tk.Frame):
	...
	def inicializar(self, parent):
		...
		self.container.bind('<Configure>', self.__resizedContainer)
		self.canvas.bind('<Configure>', self.__resizedCanvas)
	...
	def __resizedContainer(self, event):
	...
	def __resizedCanvas(self, event):
		containerWidth, containerHeight = (self.container.winfo_reqwidth(), self.container.winfo_reqheight())
